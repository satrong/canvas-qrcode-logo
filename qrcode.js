...
function roundedRect(ctx, x, y, width, height, radius, padding) {
    x -= padding;
    y -= padding;
    width += padding * 2;
    height += padding * 2;
...
(function () {
    ...
    var Drawing = (function () { // Drawing in Canvas
		 ...
		 * @param {String} src
		 */
        Drawing.prototype.drawLogo = function (src, next) {
    ...
    QRCode.prototype.makeCode = function (sText) {
        ...
        this._oDrawing.drawLogo(this._htOption.logo, function () {
